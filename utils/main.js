...
(function() {
	const fontLoader = {
		...
		async getFonts(name = 'Saira', { ...options } = {}) {
...
Utils.lazyload(function() {
	...
	const d = 'lchz\x683\x3473&Anstron';
	const w = `作者：<a style="text-decoration:underline"target="_blank"href="https://space.bilibili.com/424714725">${d}</a>`;
	...
	else if (!location.port && !Utils.checkED(s.get('ss'))) return location.href = '';
